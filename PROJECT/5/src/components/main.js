...
export default function () {
    let app = new Vue({
        ...
        data: {
            ...
            basketItems: [],
            showBasket: false,
            catalogUrl: 'https://raw.githubusercontent.com/gavrilovem/catalogData/master/catalogData.json',
            basketUrl: 'https://raw.githubusercontent.com/gavrilovem/catalogData/master/getBasket.json'
        },
        methods: {
            get(url) {
